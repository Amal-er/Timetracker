...
const ControllerComponent = () => {
  ...
  return (
    <section className="w-full md:min-w-[calc(100vw-70vw)] max-h-screen p-5 xl:p-14 bg-[#425468] text-[#47425b] md:order-1 duration-1000 relative">
      ...
      {selectedTask ? (
        <>
          ...
          <div className="h-[calc(100%-38%)]">
            <header>
              <h1 className="text-2xl p-2 text-white">History</h1>
            </header>
        ...
        <main className="w-full h-full flex justify-center items-center">
          <h1 className="text-2xl text-white">No task Selected</h1>
        </main>
      )}
    </section>
  );
